...
const ImageSlideShow = () => {
    ...
    return (
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', gap: 9 }}>
                <Box sx={{ padding: 1, backgroundColor: '#e4e4e4', boxShadow: '10px 10px 20px #c4c4c4, -10px -10px 20px #ffffff', borderRadius: '0.8rem', display: 'flex', alignItems: 'center', justifyContent: 'start', gap: 1 }}>
                    <IconButton onClick={lastImg} sx={{ padding: 1.5, border: 'none', backgroundColor: '#e4e4e4', borderRadius: '0.8rem', boxShadow: 'inset 5px 5px 5px #c4c4c4, inset -5px -5px 5px #ffffff' }}>
                        <ChevronLeftIcon />
                    </IconButton>
                </Box>
                <Box sx={{ height: '70vh', padding: 1, backgroundColor: '#e4e4e4', boxShadow: '10px 10px 20px #c4c4c4, -10px -10px 20px #ffffff', borderRadius: '0.8rem', display: 'flex', alignItems: 'center', justifyContent: 'start', gap: 1 }}>
                    <Box sx={{ height: '96%', width: '99%', padding: 1.5, border: 'none', backgroundColor: '#e4e4e4', borderRadius: '0.8rem', boxShadow: 'inset 5px 5px 5px #c4c4c4, inset -5px -5px 5px #ffffff', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Box sx={{ padding: 1, backgroundColor: '#e4e4e4', boxShadow: '10px 10px 20px #c4c4c4, -10px -10px 20px #ffffff', borderRadius: '0.8rem', display: 'flex', alignItems: 'center', justifyContent: 'start', gap: 1 }}>
                    <IconButton onClick={nextImg} sx={{ padding: 1.5, border: 'none', backgroundColor: '#e4e4e4', borderRadius: '0.8rem', boxShadow: 'inset 5px 5px 5px #c4c4c4, inset -5px -5px 5px #ffffff' }}>
                        <ChevronRightIcon />
                    </IconButton>
                </Box>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 5, mt: 7 }}>
                <Box sx={{ padding: 1, backgroundColor: '#e4e4e4', boxShadow: '10px 10px 20px #c4c4c4, -10px -10px 20px #ffffff', borderRadius: '0.8rem', display: 'flex', alignItems: 'center', justifyContent: 'start', gap: 1 }}>
